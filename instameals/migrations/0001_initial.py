# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-04-05 22:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='buyer_price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='buyer_order', to='instameals.Price'),
        ),
        migrations.AddField(
            model_name='order',
            name='meal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='instameals.Meal'),
        ),
        migrations.AddField(
            model_name='order',
            name='pickup_address',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pickup_orders', to='instameals.Address'),
        ),
        migrations.AddField(
            model_name='order',
            name='seller_earnings',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='seller_order', to='instameals.Price'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='meal',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='instameals.Price'),
        ),
        migrations.AddField(
            model_name='meal',
            name='seller',
